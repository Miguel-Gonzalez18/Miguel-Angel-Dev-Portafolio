    ...
    return (
        ...
        <div className='p-5 md:p-10' id='proyect'>
            ...
            <div className='grid md:grid-cols-3 md:gap-5'>
                {/* Proyecto 1 */}
                <div className='p-2 shadow-md rounded-lg mt-5' data-aos="fade-right" data-aos-offset="300" data-aos-easing="ease-in-sine">
                ...
                {/* Proyecto 2 */}
                <div className='p-2 shadow-md rounded-lg mt-5' data-aos="fade-up" data-aos-duration="3000">
                    <div className='w-full'>
                ...
                {/* Proyecto 3 */}
                <div className='p-2 shadow-md rounded-lg mt-5' data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">
                    <div className='w-full'>
